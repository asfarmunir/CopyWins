      ...
      <div className="space-y-4 flex-1 overflow-y-auto">
        ...
        <div>
          ...
          <div className="relative">
            ...
            >
              <span className={formData.areaOfExpertise ? "text-foreground" : "text-gray-500"}>
              ...
              <div className="absolute top-full left-0 right-0 mt-1 bg-card border border-gray-300 dark:border-slate-900 rounded-lg shadow-lg z-10">
                <div
                  className={`px-3 py-2 hover:bg-gray-50 dark:hover:bg-slate-800 cursor-pointer ${
                    formData.areaOfExpertise === "Sports" ? "bg-gray-100 dark:bg-slate-700" : ""
                  }`}
                  onClick={() => {
                ...
                <div
                  className={`px-3 py-2 hover:bg-gray-50 dark:hover:bg-slate-800 cursor-pointer ${
                    formData.areaOfExpertise === "Trading" ? "bg-gray-100 dark:bg-slate-700" : ""
                  }`}
                  onClick={() => {
    ...
    <div className="space-y-6 h-full flex flex-col">
      ...
      <div className="space-y-6 flex-1 overflow-y-auto pr-4">
        ...
        <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-slate-800 rounded-lg bg-card">
          ...
          <button
            onClick={() => handleInputChange("offerFreeTrial", !formData.offerFreeTrial)}
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
              <div>
                <div className="text-sm text-gray-600 dark:text-gray-400">with 10 subscribers</div>
                <div className="text-2xl font-bold">${(parseFloat(formData.subscriptionPrice) * 10 * 0.7).toFixed(2)}</div>
              </div>
              <div className="text-xs text-gray-500">
                After platform fees <span className="inline-block w-3 h-3 rounded-full bg-gray-400 text-white text-center leading-3">i</span>
              </div>
            </div>
            
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
              <div>
                <div className="text-sm text-gray-600 dark:text-gray-400">with 50 subscribers</div>
                <div className="text-2xl font-bold">${(parseFloat(formData.subscriptionPrice) * 50 * 0.7).toFixed(2)}</div>
              </div>
              <div className="text-xs text-gray-500">
                After platform fees <span className="inline-block w-3 h-3 rounded-full bg-gray-400 text-white text-center leading-3">i</span>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
              <div>
                <div className="text-sm text-gray-600 dark:text-gray-400">with 100 subscribers</div>
                <div className="text-2xl font-bold">${(parseFloat(formData.subscriptionPrice) * 100 * 0.7).toFixed(2)}</div>
              </div>
              <div className="text-xs text-gray-500">
                After platform fees <span className="inline-block w-3 h-3 rounded-full bg-gray-400 text-white text-center leading-3">i</span>
              </div>
        ...
        {/* Affiliate Program */}
        <div>
          <h4 className="font-semibold mb-4">Do you want to be apart of the affiliate program?</h4>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-slate-800 rounded-lg bg-card">
              <div className="flex items-center space-x-3">
                <span className="text-sm font-medium">
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h5 className="font-semibold text-orange-800 dark:text-orange-200 mb-1">Withdrawals</h5>
              <p className="text-sm text-orange-700 dark:text-orange-300">
                By registering, you agree to have your payouts securely processed and your KYC verification handled by Stripe, ensuring safe and smooth transactions.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 space-y-6">
          ...
          <div className="space-y-4 text-sm">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                All content and materials on this platform are the property of CopyWins and are protected by intellectual property laws. You may not copy, distribute, or create derivative works without our written permission. Use of our services does not grant you any ownership rights to our content.
              </p>
            </div>
  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      <div className="space-y-2">
        ...
        <p className="text-gray-500 text-sm">
          Add details to help subscribers learn more about you and your trading style.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => handleInputChange("xProfile", e.target.value)}
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="w-full sm:max-w-lg p-4 ">
        <SheetHeader className="relative mb-3 ">
