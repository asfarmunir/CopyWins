  ...
  return (
    <div className="flex h-screen w-full items-center justify-center gap-2 overflow-hidden p-4 md:p-6 ">
      <div className="relative flex flex-1  w-full flex-col items-center justify-center   p-2 md:p-8 md:py-8 2xl:p-10">
        <div className="max-h-[90svh] w-full  sm:w-fit  overflow-y-auto scroll-smooth rounded-[24px] bg-card-foreground p-6 xl:p-8  shadow-sm [scrollbar-width:none] ">
          <Image
            src={"/logo.svg"}
            alt="logo"
                    ...
                    <FormItem className="mb-4 w-full">
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="mr-0 text-xs md:text-sm  w-full rounded-[10px] border dark:bg-[#04131D] border-[#001E451A] xl:min-w-[350px] 2xl:min-w-[400px] bg-[#F5F5F5] px-3 py-3 leading-tight text-[#3E4347] "
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
